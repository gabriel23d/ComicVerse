...
const routes: Routes = [
  ...
  {
    path: 'deseados',
    loadChildren: () => import('./pages/deseados/deseados.module').then( m => m.DeseadosPageModule)
  },
  {
    path: 'admin',
  ...
  {
    path: 'network',
    loadChildren: () => import('./network/network/network.module').then( m => m.NetworkPageModule)
  },
];
